...
app.get('/', (req, res) => {
res.send('Welcome to the default site, try urls with /customers or /agents or /foods or /agents/(Agent Code) or /docs for swagger');
})
...
app.post('/agent', (req, res) => {
	...
	if(!(req.query.phonenumber.match(/^\d{3}-\d{8}$/))){
		res.err("phone number was not valid, please try again")
	}
	pool.getConnection()
		.then(conn => {
