...
app.post('/agent', (req, res) => {
	pool.getConnection()
		.then(conn => {
			conn.query("INSERT INTO agents (`AGENT_CODE`, `AGENT_NAME`, `WORKING_AREA`, `COMMISSION`, `PHONE_NO`, `COUNTRY`) VALUES (?,?,?,?,?,?)", [req.body.agent_code, req.body.agent_name, req.body.working_area, req.body.commission, req.body.phonenumber, req.body.country])
			.then((rows) => {
