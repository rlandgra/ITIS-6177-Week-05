 ...
 * /agents:
 *    post:
 *       description: insert into agents
 *       requestBody:
 *             required: true
 *             content: 
 *                  application/json:
...
app.post('/agents',  async (req, res) => {
	...
	// }
	 ...
	 try {
		 ...
		 console.log(reqbody);
		 const insertData = "insert into agents (AGENT_CODE, AGENT_NAME, WORKING_AREA, COMMISSION, PHONE_NO, COUNTRY) VALUES ('"+ reqbody.AGENT_CODE +"', '"+reqbody.AGENT_NAME+"', '"+reqbody.WORKING_AREA+"', '"+reqbody.COMMISSION+"', '"+reqbody.PHONE_NO+"', '" + reqbody.COUNTRY+"')";
